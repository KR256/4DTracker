...
WRAP_WHOLEHEAD__TRI_PATH = 'F:/CatherineShoot/catherineMeshes/wrapNeutral/catherineNeutralRescaled_tris.obj'

MASK_TRI_PATH = 'F:\CatherineShoot\catherineMeshes\wrapNeutral\catMask_withEyes_tris.obj'

DICT_PATH = 'F:\CatherineShoot\catherineMeshes\wrapNeutral\maskDicts\\faces_catMask_withEyes.json'
DICT_PATH_VERTS = 'F:\CatherineShoot\catherineMeshes\wrapNeutral\maskDicts\\verts_catMask_withEyes.json'

maskMesh = objloader.ObjLoader(MASK_TRI_PATH)
mask_vertsArray = np.array(maskMesh.v)
mask_facesArray = np.array(maskMesh.f)

headMesh = objloader.ObjLoader(WRAP_WHOLEHEAD__TRI_PATH)

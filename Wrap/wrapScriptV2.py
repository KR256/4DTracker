...
NUM_FRAMES = 60
START_FRAME = 60
INPUT_WRAP_FILE = 'C:\kyleBathStuff\Wrap\meshPropagationTris.wrap'
OUTPUT_WRAP_FILE = 'C:\kyleBathStuff\Wrap\meshPropagationTrisTemp.wrap'
MESH_SOURCE = 'C:/kyleBathStuff/Wrap/paddyHD1DivQuads/frame.%03d.obj'
MESH_TARGET = 'C:\kyleBathStuff\PaddyTracking\meshes\paddyFrame%d.obj'
OUT_MESH = 'C:/kyleBathStuff/Wrap/paddyHD1DivQuads/frame.%03d.obj'

MARKERS_TARGET = 'C:/kyleBathStuff/Wrap/WrapMarkersSparse300k/WrapMarkersSparse300kframeNew%d.txt'
MARKERS_SOURCE = 'C:/kyleBathStuff/Wrap/templateMarkers/paddyHD1DivTemplateQuads.txt'
POLYGON_FILE = 'C:/kyleBathStuff/Wrap/baseMeshSelection1SubDiv.txt'
